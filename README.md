...
```
brew install VlatkoMilisav/tap/tiler
```

Or download the latest [Tiler.dmg](https://github.com/VlatkoMilisav/Tiler/releases/latest), open it, and drag **Tiler** into **Applications**.
...
Inspired by [WindowGrid](http://windowgrid.net/) — a brilliant little Windows tool that never got open-sourced. Tiler brings the same idea to macOS, minus the mystery.

## Support
[![Help via PayPal](https://img.shields.io/badge/Donate-PayPal-0070ba?style=flat-square&logo=paypal&logoColor=white)](https://paypal.me/VlatkoMilisav)
